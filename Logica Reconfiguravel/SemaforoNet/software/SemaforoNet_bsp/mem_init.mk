...
MEM_1 := system_0_epcs_controller_boot_rom
...
$(MEM_1)_START := 0x01a81800
$(MEM_1)_END := 0x01a81fff
$(MEM_1)_HIERARCHICAL_PATH := epcs_controller
$(MEM_1)_WIDTH := 32
...
.PHONY: epcs_controller
epcs_controller: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym $(MEM_1).flash
...
$(MEM_2)_HIERARCHICAL_PATH := sdram_0
$(MEM_2)_WIDTH := 16
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: sdram_0
sdram_0: check_elf_exists $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
